...
public class FeedSayfasi extends AppCompatActivity {
    ...
    navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.Destek:
                    Intent intent = new Intent(getApplicationContext(),DestekPage.class);
                    startActivity(intent);

                    return true;
                case R.id.Hakkımızda:
                   Intent intenHakkimizda = new Intent(getApplicationContext(),Hakkimizda.class);
                   startActivity(intenHakkimizda);
                    return true;
    ...
    public void destekPage(View view){
    Intent intent = new Intent(getApplicationContext(),DestekPage.class);
    startActivity(intent);
